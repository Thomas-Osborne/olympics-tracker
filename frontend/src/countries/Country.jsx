...
export default function Country(props) {
  // List incomplete -- only 198 of 206 according to Wikipedia
  const idToCountry = {
    AFG: "Afghanistan",
  ...
  // Translates into English name for the country.
  const getCountryName = (code) => {
    return idToCountry[code] || "";
  }

  return (
    <div key={props.data.id}>
      <h3>{getCountryName(props.data.id)} ({props.data.id})</h3>
      <img src={props.data.flag_url} alt={getCountryName(props.data.id)} width="30" />
